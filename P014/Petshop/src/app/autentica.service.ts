...
export class AutenticaService {
  ...
  signupUser(email: string, password: string) {
   return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBhnR5X53OcH7gJHT18TpdZ8VgVodclRl8', 
   {
      email: email,
      password: password,
  ...
  loginUser(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBhnR5X53OcH7gJHT18TpdZ8VgVodclRl8',
    {
      email: email,
      password: password,
      returnSecureToken: true
